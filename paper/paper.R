...
####4b
#first download 175142_ABS_MAF.short.vcf.highcmplexregion.maf and 175142.filtered.annotated.maf dbGaP 
...
high_coverage_alt2 = process_recall_prec("figure4/b/maf_alt2", 
                                     "figure4/mutect2", 
                                     sep = "_T",
                                     codec_pat = "T.*ds.variants_called.txt.filtered.maf",
                                     mutect2_pat = "_ABS_MAF.short.vcf.highcmplexregion.maf")
...
std_all_mut = readRDS("figure4/d/standard/std_allmut.rds")
...
#####Figure 5
#check CODECsuite/msi/msi.R for Figure 5
